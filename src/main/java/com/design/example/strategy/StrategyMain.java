...
public class StrategyMain {
    ...
    public static void main(String[] args) {
        ...
        int num1 = 3;
        int num2 = 3;
        int add = operationStrategy.executeStrategy(num1, num2);
        operationStrategy = new OperationStrategy(new OperationSubtract());
        int subtract = operationStrategy.executeStrategy(num1, num2);
        operationStrategy = new OperationStrategy(new OperationMultiply());
        int multiply = operationStrategy.executeStrategy(num1, num2);
